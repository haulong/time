...
export default {
  ...
  mounted(){
    ...
    axios.get("/Service/callback.mi/TopList/TopListDetailsByRecommend.api?t=2018112416361283486&pageIndex=1&type=1&toplistId=2019&pageSubAreaID=2019").then(res=>{
