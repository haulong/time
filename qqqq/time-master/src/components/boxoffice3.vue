...
export default {
  ...
  mounted(){
    ...
    axios.get("/Service/callback.mi/TopList/TopListDetailsByRecommend.api?t=2018112416361283486&pageIndex=1&type=1&toplistId=2016&pageSubAreaID=2016").then(res=>{
