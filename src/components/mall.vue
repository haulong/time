	...
	<div id="newsMovie" >
		...
		<div class="lili">
			<div class="divdata"  v-for="datas in dataList">
				...
				<div class="divelse clear" v-else>
		...
		<div class="more" v-if="data">查看更多</div>
...
Vue.component(Loadmore.name, Loadmore)
	...
	export default{
		...
		mounted(){
			...
			axios.get('/Service/callback.mi/News/NewsList.api?t=2018112114144941372&pageIndex=1').then(res=>{
				console.log(res.data);
