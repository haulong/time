...
export default {
  ...
  mounted(){
    ...
    axios.get("/Service/callback.mi/TopList/TopListDetailsByRecommend.api?t=2018112416181362212&pageIndex=1&type=1&toplistId=2065&pageSubAreaID=2065").then(res=>{
