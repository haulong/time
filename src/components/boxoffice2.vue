...
<div class="nav">
	...
	<div class="filmpeople">
		<h2>{{name}}</h2>	
    <ul class="ful">
      <router-link  to="/boxoffice" activeClass="active">  <li>北美</li></router-link>
    <li>内地</li>
...
export default {
  ...
  mounted(){
    ...
    axios.get("/Service/callback.mi/TopList/TopListDetailsByRecommend.api?t=2018112416443837798&pageIndex=1&type=1&toplistId=2020&pageSubAreaID=2020").then(res=>{
     ...
     axios.get("/Service/callback.mi/TopList/TopListDetailsByRecommend.api?t=2018112416361283486&pageIndex=1&type=1&toplistId=2020&pageSubAreaID=2020").then(res=>{
