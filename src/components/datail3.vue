...
export default {
  ...
  mounted(){
    ...
    axios.get("/Service/callback.mi/TopList/TopListDetailsByRecommend.api?t=2018112416181362212&pageIndex=1&type=1&toplistId=2066&pageSubAreaID=2066").then(res=>{
