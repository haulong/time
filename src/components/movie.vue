...
export default {
  ...
  mounted(){
    ...
    axios.get("/Service/callback.mi/TopList/TopListDetails.api?t=2018112316412886678&pageIndex=1&type=2&toplistId=1474&pageSubAreaID=1474").then(res=>{
     ...
     axios.get("/Service/callback.mi/TopList/TopListDetails.api?t=2018112318391021390&pageIndex=1&type=2&toplistId=1474&pageSubAreaID=1474").then(res=>{
